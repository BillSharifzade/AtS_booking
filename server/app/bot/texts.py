...
_TEXT_DEFS: list[tuple[str, str, str, str]] = [
    ...
    ("PICK_GRADE", "Процесс заявки", "Запрос: грейд заявителя", "Выберите грейд заявителя:"),
    ("INVALID_GRADE", "Ошибки ввода", "Ошибка: грейд заявителя", "Выберите грейд заявителя из предложенных вариантов."),
    ...
    (
        ...
        "Процесс заявки",
        "Запрос: департамент",
        "Укажите департамент/отдел участников мероприятия:",
    ),
    (
    ...
    # Asked only for VIP rooms — everywhere else the coffee break is standard and
    # there is nothing to choose (see handlers._room_is_vip).
    ("COFFEE_TYPE_QUESTION", "Процесс заявки", "Запрос: тип кофе-брейка", "Что нужно на кофе-брейке? Выберите «стандарт» (печенье, кофе, чай, конфеты) или «Конфеты, сухофрукты, вода 0,5 л»."),
